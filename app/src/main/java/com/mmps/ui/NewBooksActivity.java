            ...
            try {
                ...
                btnSearch.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (SOAPUtils.isNetworkConnected(NewBooksActivity.this)) {
                            if (!etSearchBook.getText().toString().isEmpty()) {
                                ...
                                new LibraryTasks(URLConstants.ACTION_SEARCH_BOOK, map, NewBooksActivity.this).execute();
                            } else {
                                etSearchBook.setError(getString(R.string.cannot_be_empty));
                            }
                        } else {
                            Toast.makeText(NewBooksActivity.this, getString(R.string.no_internet_connection), Toast.LENGTH_LONG).show();
                        }
                    }
                });
                ...
                if (getIntent().hasExtra("books")) {
                    ...
                    if(bookModels.get(0).getType() == ActionTypes.TYPE_NEW_BOOKS){
                            title.setText(getString(R.string.new_books));
                    }else if(bookModels.get(0).getType() == ActionTypes.TYPE_RARE_BOOKS){
                        title.setText(getString(R.string.rare_books));
                    }

                    rvNewBooks.setAdapter(new RecyclerAdapter(NewBooksActivity.this, "http://" + libraryResponseModel.getWebsite() + "/CP/Uploads/BookImages/", bookModels));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
